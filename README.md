...
台灣的選舉、公職人物、政見與政治獻金資料分散在不同機關、文件與資料格式中。Public Office Watch 將這些資料整理成可搜尋、可比較且保留來源的公共資料介面，讓一般使用者不必先理解各機關的資料結構，也能從同一個人物或選舉脈絡開始查找。

這是一個直接提供給公眾使用的開源 civic-tech 產品，不是供開發者安裝的套件。專案影響力更適合以正式網站的使用情況、可查詢資料範圍、搜尋曝光、外部更正回報與持續維護紀錄衡量，而不只看套件下載、GitHub stars 或 forks。
...
![首頁與縣市導覽](docs/readme-assets/home.jpg?v=20260826)
...
![選舉年份與大選總覽](docs/readme-assets/elections.jpg?v=20260826)

### 人物搜尋與人物頁

人物列表支援姓名搜尋，以及地區、政黨、身分與狀態篩選，並提供欄位排序與分頁。全域搜尋也可從頁首直接查找人物、公司、政黨、選舉與地區。

![人物搜尋與篩選](docs/readme-assets/people.jpg?v=20260826)
...
![人物詳細資料](docs/readme-assets/person.jpg?v=20260826)

### 政黨與政治獻金

政黨頁整理政黨基本資料、相關人物與年度政治獻金摘要。政治獻金以政黨及公司層級的彙總資訊為主，不公開個人捐贈明細，並保留資料來源與更新時間。

![政黨與政治獻金](docs/readme-assets/parties.jpg?v=20260826)
...
- 批次整理與文字轉換可能造成斷句、標點、截斷或欄位拆分問題；無法保證每筆學經歷、政見與其他文字均已逐字人工確認，重要判斷仍應回看原始來源。
...
本專案以 ISC License 公開原始碼，由核心維護者持續維護。歡迎透過 GitHub Issues 回報錯誤、補充可查核來源或提出功能建議，也可依 [CONTRIBUTING.md](CONTRIBUTING.md) 提交 Pull Request；涉及人物身分、選舉結果、政治獻金或其他敏感公開資料的變更，仍須依本站資料原則完成人工審核。
...
目前已具備全國與縣市導覽、手機版「我的選舉」第一階段、選舉與人物查詢、候選人政見與基本比較、政見履行情況社群投票、政黨與政治獻金摘要、公開更新動態、情境式聊天室，以及中英文介面。

### 接下來的方向（2026-09-08）

- **優先評估 PWA 與公職任內紀錄**：已有 manifest、service worker 與離線提示頁，下一步評估安裝、更新與離線狀態體驗；不代表已支援離線查詢完整資料。任內紀錄尚未開始正式 PoC，先規劃中央立委試行，再評估地方議會。
- **已上線並持續維護**：手機版「我的選舉」Phase 1、Cloudflare Web Analytics，以及搜尋品質／上線後檢查；後續依實際使用情況微調 UX 與搜尋排序。
- **持續補齊資料**：2026 登記生命週期第一階段已完成，資格審定、號次與正式名單依官方公告接續更新。投開票所與鄰別精準對應已涵蓋 15／22 縣市，其餘 7 縣市待來源確認；政治獻金、公司關係與文字品質持續維護，司法專屬同步／下架流程仍待完善。
- **後續再評估**：候選人比較 2.0、「自上次查看後有什麼變化」、地方議會活動與政見履行證據時間線。現有社群投票不等同任內活動的事實追蹤。
- **暫緩與範圍**：候選人問卷目前不做；不規劃面向使用者的 AI 功能，維持 UI/UX-first。Codex 協助開發與維護的既有流程不變。

完整進度與依賴關係見 [2026 Product Roadmap](docs/product-roadmap-2026.md)，網站「關於本站」提供相同方向的中英文摘要。以上為目前優先順序，依官方來源與試行結果調整，沒有固定上線承諾。
