...
const roadmapStages = [
  {
    ...
    itemKeys: [
      'about.roadmapCompletedMobile',
      'about.roadmapCompletedBrowse',
      'about.roadmapCompletedFeedback',
      'about.roadmapCompletedAnalytics',
      'about.roadmapCompletedSearch',
    ],
  ...
  },
  {
    ...
    itemKeys: [
      'about.roadmapCurrentRegistration',
      'about.roadmapCurrentPolling',
      'about.roadmapCurrentQuality',
      'about.roadmapCurrentDonations',
      'about.roadmapCurrentJudicial',
    ],
  ...
  },
  {
    ...
    itemKeys: [
      'about.roadmapNextPwa',
      'about.roadmapNextTermRecords',
    ],
  ...
  },
  {
    ...
    itemKeys: [
      'about.roadmapLaterCompare',
      'about.roadmapLaterChanges',
      'about.roadmapLaterEvidence',
      'about.roadmapLaterCouncils',
      'about.roadmapLaterQuestionnaire',
      'about.roadmapLaterAi',
    ],
