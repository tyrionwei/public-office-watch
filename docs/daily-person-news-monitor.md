...
- 黨籍異動：退黨、入黨、開除或恢復黨籍。
- 參選異動：退選、停止競選、不再參選或候選資格變動。
- 公職異動：請辭、停職、解職、罷免、遞補或補選。
- 司法程序：搜索、約談、聲押、羈押、交保、起訴、判決與定讞。

一般政治評論、政策攻防、民調與私人生活新聞不在此流程內。

候選人登記、完成登記、正式登記與撤回登記等新聞不納入每日新聞蒐集或審核。候選登記名冊及其後續異動依中選會／地方選委會的官方公布時程另行同步；新聞流程不再重複補搜或建立登記待審項目。黨籍加入、退出、開除、停權或恢復，以及退選、停止競選與候選資格異動仍在監測範圍。
...
- 純候選登記新聞即使符合舊版設定，也會在建立線索前排除；登記狀態只採官方中選會流程。
