...
- 劉成謙、陳泓維、徐慈檉、蕭夙玲、黃朝淵共 5 筆維持本機待審核；B 級、同名衝突
  及新人物均不自動決定。
...
- 目前本機共確認 216 / 318 筆：民主進步黨 158、中國國民黨 9、台灣民眾黨 32、
  時代力量 7、台灣基進 2、小民參政歐巴桑聯盟 4、親民黨 4；台灣綠黨 0。
- 其餘 102 筆保留本機審核工作台：B 級 9、需辨識同名人物 12、新人物 81。
- 本機驗證共有 216 筆私有 `party_nominee` 候選關係及 216 筆 `review_only` 聲明；
  公開候選與公開聲明均為 0。
