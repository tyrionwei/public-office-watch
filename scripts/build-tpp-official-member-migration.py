...
-- Preserve source snapshots even when a previously reviewed person was never
-- imported into this database. Only exact UUID/name matches can receive links.
DELETE FROM _tpp_official_profiles AS profile
WHERE NOT EXISTS (
