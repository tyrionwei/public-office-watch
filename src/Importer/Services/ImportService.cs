...
public sealed class ImportService
{
    ...
    public void RunDryRun(ChangeSet changeSet)
    {
        ...
        Console.WriteLine($"  newCandidates={changeSet.Summary.NewCandidates}");
        Console.WriteLine($"  updateCandidates={changeSet.Summary.UpdateCandidates}");
        Console.WriteLine($"  rejectedCandidates={changeSet.Summary.RejectedCandidates}");
