...
DROP FUNCTION published.search_public_records(TEXT, INTEGER);

CREATE FUNCTION published.search_public_records(
    p_query TEXT,
...
COMMENT ON FUNCTION published.search_public_records(TEXT, INTEGER) IS
    'Returns at most 12 ranked published search matches with party context for people.';
