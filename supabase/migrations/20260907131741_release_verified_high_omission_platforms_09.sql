...
('059160b7-9ab1-4010-b8a8-0c42930b5ab0'::uuid,'abf2082c-c7c9-4493-aabd-cc9392298b9d'::uuid,'2ec28c65-dfde-4b8f-95b9-ec946c2d6fe8'::uuid,'cec-platform:2022:votetw-candidate-feea3dbae3dcd6e3','1、 推動高雄捷運延伸屏東 , 經台 1 線進入客家鄉鎮之環狀路廊 , 促進地方發展。
2、 推動公墓遷葬種電 , 在綠電下增建體育休閒園區和公益設施。
3、 推動污水下水道接管率 , 改善河川污染環境衛生。
4、 推動建設客家鄉鎮交通網連結便捷性。
(1)185 線沿山公路枋寮鄉 ( 隆山村 ) 至內埔鄉 ( 隘寮村 ) 高架快速道路並延伸國道 3 號。
(2)「'' 高雄一屏東第二東西向快速公路」 延伸至內埔鄉境內為終點。
(3) 國道 3 號於竹田鄉南勢、 頭嗇段設立體交流道。
(4) 屏 107 線拓寬工程 (內埔鄉文化路通往萬弦村五溝村道路 )。
(5) 屏 86 線拓寬工程 (內埔鄉豐田村至東勢村 )。
(6) 屏 85 線拓寬工程 (內埔鄉振豐村新東路並改善排水溝 )。
(7) 開關內埔鄉豐田地區都市計畫區 15 米外環道路。
5、 推動龍頸溪、 五溝村水系環狀水岸環境營造、 淨水設施 , 發展聚落觀光。
6、 加強整治區域排水功能 ; 推廣在地滯洪 , 增加承洪歡性。','1. 推動高雄捷運延伸屏東，經台1線進入客家鄉鎮之環狀路廊，促進地方發展。
2. 推動公墓遷葬種電，在綠電下增建體育休閒園區和公益設施。
3. 推動汙水下水道接管率，改善河川汙染環境衛生。
4. 推動建設客家鄉鎮交通網連結便捷性：
（1）185線沿山公路枋寮鄉（隆山村）至內埔鄉（隘寮村）高架快速道路並延伸國道3號。
（2）「高雄－屏東第二東西向快速公路」延伸至內埔鄉境內為終點。
（3）國道3號於竹田鄉南勢、頭崙段設立體交流道。
（4）屏107線拓寬工程（內埔鄉文化路通往萬巒鄉五溝村道路）。
（5）屏86線拓寬工程（內埔鄉豐田村至東勢村）。
（6）屏85線拓寬工程（內埔鄉振豐村新東路並改善排水溝）。
（7）開闢內埔鄉豐田地區都市計畫區15米外環道路。
5. 推動龍頸溪、五溝村水系環狀水岸環境營造、淨水設施，發展聚落觀光。
6. 加強整治區域排水功能；推廣在地滯洪，增加承洪韌性。'),
('4a6da7e9-6f69-471f-88ac-a9f6ba7091d8'::uuid,'dd044d90-04e9-4419-be4f-74b3864c1a94'::uuid,'41db1cbd-ecb3-42cd-9e0c-76d9ddc89323'::uuid,'cec-platform:2022:votetw-candidate-8107edf0c2b63e5d','109 年全民運滑輪曲棍南投縣代表隊
美國兩加州大學國際學程
延緩失能指導員','1、簡化長照申請流程。
2、廣設托育，減輕家長的負擔。
3、推廣藝文活動，支持在地藝術家。
...
9、青銀共生，創造新世代。
10、推展創客，提升南投軟實力。'),
('adcaaf12-8e2b-4fbb-a2b5-6d9fda543e29'::uuid,'79c23b82-d62f-45c5-b819-59b90e882b8e'::uuid,'f9ca8fcf-4be3-4254-8341-71ed29d22f55'::uuid,'cec-platform:2022:votetw-candidate-9f27faed67e28ef1','一、 支持陳其邁市長的產業政策 :
創造高雄產業轉型 , 力爭台積電 , 催生橋頭科學園區 , 打造高雄時代。
二、 支持陳其邁市長的社宅政策 :
面對高房價 , 積極興建社會住宅 , 並放寬社會住宅限制。
三、 支持陳其邁市長的交通政策 :
1. 規劃從高鐵進右昌、 高雄大學、 橘頭科學園區的捷運紫線。
2,. 規劃左營楠樣段鐵路立體化。
3. 台積電 ( 原中油 ) 南側園區南路通以華路到民族路 ; 縫合左營楠梓交通,2020 完成打通新莊一路銜接勝利路 , 縮短新舊部落
距離 ; 改善國道十號交流道 , 持續推動國十生活圈路網便捷性。
4. 新台 17 線到左營南門圓環全段已於 2022 經行政院協調 , 還方定案 , 明年動工 , 拼 2025 全線通車。
5. 犁華路拓寬 10 公尺。
四、 友善育兒環境 , 爭取政府編列育兒津貼到每月五千元 , 推動非營利及公立幼兒園 , 減輕年輕家庭負擔。
五、 將兒童共融遊具搬入藍田公園、 右昌森林公園、 國昌公園、 清豐公園、 福山公園、 蓮池潭兒童公園。
六、 監督楠仔坑運動中心 2024 年如期啟用 , 並爭取到外環步道 , 給楠仔坑市民朋友散步。
七、 打造溫暖、 疼惜長輩的友善城市 , 讓長輩在年輕人上班時間可以走出家門 , 到巷弄照護站兼顧健康與休閒。
八、 保存左營在地荐村文化 , 結合見城計畫與眷村重整 , 打造左營眷村觀光資產 , 找回左營老記憶。
九、 推動中油宿舍區的保存與未來 , 宏毅宿舍應做保留 , 宏南宿舍空間活化 , 與市政府合作產業住宅 , 給宿舍居民一個末來。','一、支持陳其邁市長的產業政策:創造高雄產業轉型,力爭台積電,催生橋頭科學園區,打造高雄時代。
二、支持陳其邁市長的社宅政策:面對高房價,積極興建社會住宅,並放寬社會住宅限制。
三、支持陳其邁市長的交通政策:
1.規劃從高鐵進右昌、高雄大學、橋頭科學園區的捷運紫線。
2.規劃左營楠梓段鐵路立體化。
3.台積電(原中油)南側園區南路通翠華路到民族路;縫合左營楠梓交通,2020完成打通新莊一路銜接勝利路,縮短新舊部落距離;改善國道十號交流道,持續推動國十生活圈路網便捷性。
4.新台17線到左營南門圓環全段已於 2022 經行政院協調,軍方定案,明年動工,拼2025全線通車。
5.翠華路拓寬10公尺。
四、友善育兒環境,爭取政府編列育兒津貼到每月五千元,推動非營利及公立幼兒園,減輕年輕家庭負擔。
五、將兒童共融遊具搬入藍田公園、右昌森林公園、國昌公園、清豐公園、福山公園、蓮池潭兒童公園。
六、監督楠仔坑運動中心 2024 年如期啟用,並爭取到外環步道,給楠仔坑市民朋友散步。
七、打造溫暖、疼惜長輩的友善城市,讓長輩在年輕人上班時間可以走出家門,到巷弄照護站兼顧健康與休閒。
八、保存左營在地眷村文化,結合見城計畫與眷村重整,打造左營眷村觀光資產,找回左營老記憶。
九、推動中油宿舍區的保存與未來,宏毅宿舍應做保留,宏南宿舍空間活化,與市政府合作產業住宅,給宿舍居民一個末來。'),
('bfee0c02-8db3-4d9e-9915-4bcc44ef56e3'::uuid,'368d7251-58d5-4cdb-86e0-a91bc663a5df'::uuid,'da0871d4-a737-4a59-87db-3c29f69350e0'::uuid,'cec-platform:2022:votetw-candidate-61081f0999883d06','一、 加強縣內防災救難人員組織培訓 1. 提高保險額度保障加倍 2. 防護設備要升級 3. 更新
救難機具、 守護縣民生命財產。
二、 加強警察、 消防、 救難人員裝備升級。
三、 整合社會福利資源 1. 日間照顧服務 2. 外籍配偶多元服務 3. 兒童青少年學習 4. 樂齡
學才與傳承中心。
四、 強化社區互動與聯結 , 設置社區福利餐廳與課輔教室。
五、 加強青少年戶外體適能活動 , 補助設施及經費 , 爭取運動場地 , 以強健體魄。
六、 加強校園安全。','一、加強縣內防災救難人員組織培訓：1. 提高保險額度保障加倍；2. 防護設備要升級；3. 更新救難機具、守護縣民生命財產。
二、加強警察、消防、救難人員裝備升級。
三、整合社會福利資源：1. 日間照顧服務；2. 外籍配偶多元服務；3. 兒童青少年學習；4. 樂齡學習與傳承中心。
四、強化社區互動與聯結，設置社區福利餐廳與課輔教室。
五、加強青少年戶外體適能活動，補助設施及經費，爭取運動場地，以強健體魄。
六、加強校園安全。'),
('d493a215-b575-4996-a520-b6195af0ed33'::uuid,'2ffa1d96-4a57-44b5-983f-805221f3281e'::uuid,'f07ed24e-ae36-4aad-9502-884c0cdcb579'::uuid,'cec-platform:2022:votetw-candidate-0cae20e753eb103d','南投縣議會第十八屆、 第十九屆縣議員
宏仁國中第一屆校友會理事長
埔里鎮民代表會第十九屆代表
埔里鎮民代表會第十八屆主席
國民黨埔里鎮黨部前副主任委員
環有以國際同濟會 2007/2008 會長
南投縣埔里家扶中心扶幼委員
慈濟功德會長期會員','一、督促縣政府對於人民申請案件,建立透明查詢機制,以掌握時效。
二、打造南投一日生活圈,建構更便利的交通網絡。
三、推廣在地產業文化,結合休閒觀光,以利民益。
四、建請縣政府盤點公有土地,主動釋出,以共營方式提供地方創生、生產場域,留住青年。
五、重視長輩的身心照護,加強推動各項福利措施,營造友善環境讓老有所養,老有所依,人人能安
居樂業。'),
('eb9a9042-3511-4373-9db9-390a0e637761'::uuid,'941b6b2c-d225-40c3-b68f-86fcd05828f3'::uuid,'7d3d1590-f02b-4b25-a66a-bb800ed45b13'::uuid,'cec-platform:2022:votetw-candidate-ac6c4c959ed8ff58','0@ 人體育、 音樂、 育樂、 強化孩童、 心、 身、 靈的健康快樂。
@ 觀光、 娛樂、 海洋與山區的開展熱鬧。
@ 鄰近城市的互惠合作、 桃園市、 新北市、 台中市、 新竹縣、 花蓮縣百萬買房子、 億萬買好
鄰居。 (好鄰居、 勝過好房子 )
@ 蘇澳、 南澳、 頭城、 壯圍、 五結加起來面積多新加坡近 1 倍大 , 新加坡能宜蘭為何不能 ?
@ 宜蘭是世界的淨土、 地球唯一的淨土、 只欠福報。','一、監督縣政
1. 反對家族干政，建立廉能宜蘭縣政。
2. 推動地方自治修法與立法。
