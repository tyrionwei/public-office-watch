...
('05cd932d-2d1c-4b05-a02a-2ce06835cf9d'::uuid,'b346dc00-d690-43ef-9545-24068fa10df3'::uuid,'7a65fdab-7456-4405-aa06-733b3c1d06e4'::uuid,'cec-platform:2022:votetw-candidate-0390390793980041','Tae et he ee one ew BCI ES eee
。簡化青創輔導申請程序 G。推動台鐵宿舍村為國家級園區
‘SESHRRAL HAS。加強住宿產業創造觀光新動能
Hike - See” GC ee. cea Ma co
. stipniepeaapelilpt iQ —"。引介公私部門資源協助社區據點
。爭取共融式公園全
A。增加據點、不老健身房進入社區
‧守護八卦山脈水土環境保持 oe *BMRES * SORA RE AGH
3 吧
BRB- UAB 三| Pree ae oe a eM
ROLE. RRR iS l=?。打造母語環境、提升外語教育資源
ry wont。新增0到3歲幼兒公共托育系統
強化行人安全 6@ 新生代尚少年 “擴展兒生親子館服務內容與範圍','◆ 挺青年，紮根家鄉
1. 簡化青創輔導申請程序
2. 落實勞動權益與性別友善
...
◆ 整交通，以人為本
1. 監督工程、減緩彰化交流道區域壅塞問題
2. 檢討不合理待轉、人本設計強化行人安全
...
2. 新增0到3歲幼兒公共托育系統
3. 擴展兒童親子館服務內容與範圍'),
('1324dba3-bd10-4851-95cf-ec4e6ac6cfca'::uuid,'ee824add-3d6a-4d3b-a2c2-acc4fae63c55'::uuid,'e10b7be5-0649-48a1-ae8d-757fe464ba26'::uuid,'cec-platform:2022:votetw-candidate-e29261850f6f639f','一、花蓮吉安鐵路高架雙軌電氣化 ( 花蓮 - 吉安 )，108 年已完成可行性評估，爭取吉安鄉段全程高架化。
二、國土規劃，擴大花蓮土地利用價值及經濟效益，吉安鄉東側海岸線土地規劃為風景休閒區。
三、大花蓮都市計畫，擴大吉安鄉、花蓮市、新城鄉都市計畫，以利地方繁榮發展。
四、國土計畫新增宗教用地，補辦寺廟登記，比照工業輔導法辦理，以利宗廟納管與輔導。
五、因天候異常，災難頻傳，基礎建設非常重要，地方防洪工程及排水系統，應確實規劃並爭取經費辦理。
六、為照顧農民，增加資材補助，協助農業加工升級，鼓勵青年返鄉投入有機農業生產，扶植有機農業並結
合觀光休閒，增加農民收益。
七、落實照顧婦女、老人、殘疾、低收入戶及弱勢團體，結合社會資源，爭取閒置空間，成立老人日托中心，
提供完善照顧及加強各社區關懷福氣站功能。
八、黃馨期待以豐富完整的資歷及經驗，繼續營造花蓮，讓花蓮成為樂活友善、安全、養生、觀光、休閒的
魅力城市。','一、花蓮吉安鐵路高架雙軌電氣化 ( 花蓮 - 吉安 ),108 年已完成可行性評估,爭取吉安鄉段全程高架化。
二、國土規劃,擴大花蓮土地利用價值及經濟效益,吉安鄉東側海岸線土地規劃為風景休閒區。
三、大花蓮都市計畫,擴大吉安鄉、花蓮市、新城鄉都市計畫,以利地方繁榮發展。
四、國土計畫新增宗教用地,補辦寺廟登記,比照工業輔導法辦理,以利宗廟納管與輔導。
五、因天候異常,災難頻傳,基礎建設非常重要,地方防洪工程及排水系統,應確實規劃並爭取經費辦理。
六、為照顧農民,增加資材補助,協助農業加工升級,鼓勵青年返鄉投入有機農業生產,扶植有機農業並結合觀光休閒,增加農民收益。
七、落實照顧婦女、老人、殘疾、低收入戶及弱勢團體,結合社會資源,爭取閒置空間,成立老人日托中心,提供完善照顧及加強各社區關懷福氣站功能。
八、黃馨期待以豐富完整的資歷及經驗,繼續營造花蓮,讓花蓮成為樂活友善、安全、養生、觀光、休閒的魅力城市。'),
('6e45b6bb-b945-478b-b880-1257b464cc8d'::uuid,'3d811542-4709-409e-b133-8d40b1477b4c'::uuid,'d80e9a05-731d-42a8-a368-cd5ed55e197f'::uuid,'cec-platform:2022:votetw-candidate-b67334776fb2b15e','高雄景氣蕭條 , 風華不再 . 人口不增反減 , 尤其苓雅、 新興、 前金為最。
紹庭提出 「重振港都雄風三箭」、「安居樂業五大良方」
TERE
1. 交通 : 推動台灣高鐵南延至高雄車站 , 帶來豐沛人潮 , 以促進南高雄之發展。
2. 產業 : 推動 IC 設計產業進駐 「亞洲新灣區」, 打造高雄 「北台積 , 南 IC」 產業鏈 ,
讓半導體產業延伸到南高雄 . 繁榮南高雄。
3. 居住 : 加速市區危老大樓都更與改建 , 維護居住安全及美化城市景觀。
「安居五方」:
1. 解決高雄空污問題 . 讓高雄人呼吸新鮮空氣。 cE
2. 廣設社會住宅 , 讓居者有其屋 , 落實居住正義。 aA te
3. 增設日照、 長青中 BEEENEEHTREEEIE. coo
4. 爭取警沙人員福利 , 體必辛勞 , 保障市民生命財產之安全。
5. 拒絕市府隨意提高地價稅、 房屋稅、 污水費等, 為市民看緊銜包。','高雄景氣蕭條、風華不再，人口不增反減，尤其苓雅、新興、前金為最。
紹庭提出「重振港都雄風三箭」、「安居樂業五大良方」。

「重振三箭」：
1. 交通：推動台灣高鐵南延至高雄車站，帶來豐沛人潮，以促進南高雄之發展。
2. 產業：推動IC設計產業進駐「亞洲新灣區」，打造高雄「北台積、南IC」產業鏈，讓半導體產業延伸到南高雄，繁榮南高雄。
3. 居住：加速市區危老大樓都更與改建，維護居住安全及美化城市景觀。

「安居五方」：
1. 解決高雄空污問題，讓高雄人呼吸新鮮空氣。
2. 廣設社會住宅，讓居者有其屋，落實居住正義。
3. 增設日照、長青中心，顧老護幼，讓青壯市民無後顧之憂。
4. 爭取警消人員福利，體恤辛勞，保障市民生命財產之安全。
5. 拒絕市府隨意提高地價稅、房屋稅、污水費等，為市民看緊荷包。'),
('a5497a9a-b560-436d-b7f3-bada38074ab4'::uuid,'c97b365d-6112-4bd6-8038-bfc9dc5c0304'::uuid,'b699d590-d1df-4f77-8d4f-542a6debbb0b'::uuid,'cec-platform:2024:votetw-candidate-58cb43109600ac4e','政見
市政歷練和教育博士最專業認真的民意代表
市政府歷練近8年,目前擔任議員,具有教育 > 讓長輩得到更好的照記
專業,勇敢為民發聲,爭取建設 ! 元之博士論文研究活躍老化,會給長划
一一一一一一一一 最高的尊重,改良長照制度,提升長者
> 建設板橋 說到做到 絕不割稻必 休閒設施,增設優質養老院,申請看護
作戰議員期間爭取到新北首座天莫籃球場 。 免蔬反量表。
、公園體 設施、道路開 ‘ {TENS <r NAH ep se
MEP Pn Bae | Te ee cm mean
HED o 來至 ay 5 Fz 2 \ 日 FE to + 9» AN Ls
Bl ARESTRENE SAN A TET ae
#法杜絕詐騙、守護人民辛苦血汗錢。
y 加速推動都市更新,浮洲區盡快通過都 了修法生可詐騙、本讓人人民半半邊汗炙
市計畫,興建盾水下水道。 強健電網,不要動不動停電;推動電線
》 發揮教育專業,改善教育政策 還
檢討教育制度,讓孩子快樂學習,支持多 y 檢討交通記點制度,推動友善人本交通
元社團活動。 ,取消區間測速。','市政歷練和教育博士，最專業認真的民意代表

市政府歷練近8年，目前擔任議員，具有教育專業，勇敢為民發聲、爭取建設！

建設板橋，說到做到，絕不割稻尾

任職議員期間爭取到新北首座天幕籃球場、公園體健設施、道路開闢、人行道改善、社區污水下水道接管、更新學校設備等建設。未來至中央爭取更多預算，積極建設板橋。
...
元之博士論文研究活躍老化，會給長輩最高的尊重，改良長照制度，提升長者休閒設施，增設優質養老院，申請看護免巴氏量表。
...
('ddf580b9-92ca-4970-a73b-4b86b2a30c07'::uuid,'d40001ae-5431-41be-8f28-875b13e57155'::uuid,'968b0b4d-4680-44f8-b4d7-5c95ae915e56'::uuid,'cec-platform:2022:votetw-candidate-ffb88fa8b49213b4','為婦幼點燈，嫈珺正全力爭取:
 生育津貼一胎 2 萬以上，添購新生兒用品
 每位產婦坐月子津貼 1 萬，保障產婦基礎營養
 補助每位新生兒之安全座椅 4 千，保障嬰幼兒童乘車安全
嫈珺的努力
 讓全縣 155 間國中小營養午餐優化，從最低標案方式改成最有利標，讓學童吃更好
 邀約跨局處把關學童交通車安全、稽查補習班師資良民證
 不定期稽查校園飲水機濾心品質，學童喝得更安心
 建置食農教育教學資源平臺，讓國產食材內容深入校園
 繼續盤點地方需求，爭取中央與地方建設工程經費
 舉辦法律座談會，與民共同提升法律知識
 推動性平講座，同時支持 18 歲的青年爭取公民權
 打造嘉義縣最大運動賽事「跑若飛天公盃路跑」
，共創地方商機
 推動社區營造、農村再生及地方創生，帶動地方多元發展
 栽培地方學子成為舞蹈運動國手，將來為國爭光
 復興朴子真人藝閣文化，維護地方傳統','為婦幼點燈，嫈珺正全力爭取：

1. 生育津貼一胎2萬以上，添購新生兒用品。
2. 每位產婦坐月子津貼1萬，保障產婦基礎營養。
3. 補助每位新生兒之安全座椅4千，保障嬰幼兒童乘車安全。
4. 讓全縣155間國中小營養午餐優化，從最低標案方式改成最有利標，讓學童吃更好。
5. 邀約跨局處把關學童交通車安全、稽查補習班師資良民證。
6. 不定期稽查校園飲水機濾心品質，學童喝得更安心。
7. 建置食農教育教學資源平臺，讓國產食材內容深入校園。
8. 繼續盤點地方需求，爭取中央與地方建設工程經費。
9. 舉辦法律座談會，與民共同提升法律知識。
10. 推動性平講座，同時支持18歲的青年爭取公民權。
11. 打造嘉義縣最大運動賽事「跑若飛天公盃路跑」，共創地方商機。
12. 推動社區營造、農村再生及地方創生，帶動地方多元發展。
13. 栽培地方學子成為舞蹈運動國手，將來為國爭光。
14. 復興朴子真人藝閣文化，維護地方傳統。');
